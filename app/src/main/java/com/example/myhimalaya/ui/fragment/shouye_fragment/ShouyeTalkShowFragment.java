...
public class ShouyeTalkShowFragment extends BaseFragment implements ITitleCallBack {
    private static final String TAG = "ShouyeTalkShowFragment";
    ...
    public void initView(View mView) {
        ...
        viceTitlePresenter.getViceTitle("12", "0");
        viceTitlePresenter.getBanner("12");
    }
