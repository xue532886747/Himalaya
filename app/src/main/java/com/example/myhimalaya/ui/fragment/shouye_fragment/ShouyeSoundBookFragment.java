...
public class ShouyeSoundBookFragment extends BaseFragment  implements ITitleCallBack {
    private static final String TAG = "ShouyeSoundBookFragment";
    ...
    public void initView(View mView) {
        ...
        viceTitlePresenter.getViceTitle("3", "0");
        viceTitlePresenter.getBanner("3");
    }
    ...
    public void initEvent() {
        viceTitleAdapter.setOnFoldClickListener(new ViceTitleAdapter.onFoldClickListener() {
            ...
            public void isFold(boolean isFold) {
                if (isFold) {       //true 需要折叠
                    viceTitleAdapter.setFoldNumber(mNumber);
                } else {              //需要打开
