...
public class ShouyeAmuseMentFragment extends BaseFragment implements ITitleCallBack {
    private static final String TAG = "ShouyeAmuseMentFragment";
    ...
    public void initView(View mView) {
        ...
        viceTitlePresenter.getViceTitle("4", "0");
        viceTitlePresenter.getBanner("4");
    }
