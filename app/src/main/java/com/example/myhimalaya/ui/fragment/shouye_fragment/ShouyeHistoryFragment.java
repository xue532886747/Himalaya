...
public class ShouyeHistoryFragment extends BaseFragment implements ITitleCallBack {
    private static final String TAG = "ShouyeHistoryFragment";
    ...
    public void initView(View mView) {
        ...
        viceTitlePresenter.getViceTitle("9", "0");
        viceTitlePresenter.getBanner("9");
    }
